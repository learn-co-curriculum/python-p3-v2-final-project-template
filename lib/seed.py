...
def seed_database():
    ...
    level21 = Level.create("3-j", "Advanced", "Cryptocurrencies employ blockchain technology, disrupting traditional finance and ushering in a decentralized era of digital transactions.")
